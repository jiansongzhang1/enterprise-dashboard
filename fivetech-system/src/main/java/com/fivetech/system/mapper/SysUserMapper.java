...
public interface SysUserMapper
{
     ...
     *
     * @param userId 用户ID
     * @param gaSecret Base32密钥
     * @param gaStatus Google Authenticator状态
     * @return 更新行数
     */
    public int updateGaSecretIfEmpty(@Param("userId") Long userId,
                                     @Param("gaSecret") String gaSecret,
                                     @Param("gaStatus") Integer gaStatus);
     ...
     * @param userId 用户ID
     * @param channel 通知渠道
     * @param contactJson 联系人JSON片段
     * @return 更新行数
     */
    public int updateNotificationContact(@Param("userId") Long userId,
