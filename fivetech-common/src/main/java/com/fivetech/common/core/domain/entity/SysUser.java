package com.fivetech.common.core.domain.entity;
...
import com.fivetech.common.xss.Xss;
...
public class SysUser extends BaseEntity
{
    ...
    /** 通知联系人信息（Telegram、WhatsApp、Lark等） */
    ...
    /** Google Authenticator 状态（0未开通 1待绑定 2已绑定） */
    ...
    {
        return UserTypeEnum.isSuperAdmin(this.userType);
    }
    ...
    public String getNotificationContacts()
    {
        return notificationContacts;
    }

    public void setNotificationContacts(String notificationContacts)
    {
