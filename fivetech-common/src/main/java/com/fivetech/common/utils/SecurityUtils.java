...
public class SecurityUtils
{
    ...
    public static boolean isAdmin()
    {
        try
        {
            return getLoginUser().getUser() != null && getLoginUser().getUser().isAdmin();
        }
        catch (Exception e)
        {
            return false;
    ...
    /**
     * 判断指定用户是否为当前登录用户的超级管理员身份。
     * 任意用户的身份应通过用户实体的 isAdmin() 判断，避免仅凭用户 ID 推断权限。
     * 
     * @param userId 用户ID
     * @return 结果
     */
    public static boolean isAdmin(Long userId)
    {
        ...
        try
        {
            ...
            return userId.equals(loginUser.getUserId())
