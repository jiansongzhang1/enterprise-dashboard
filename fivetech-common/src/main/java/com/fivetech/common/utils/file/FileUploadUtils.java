package com.fivetech.common.utils.file;
...
import com.fivetech.common.exception.file.FileNameLengthLimitExceededException;
import com.fivetech.common.exception.file.FileSizeLimitExceededException;
import com.fivetech.common.exception.file.InvalidExtensionException;
import com.fivetech.common.utils.DateUtils;
import com.fivetech.common.utils.StringUtils;
import com.fivetech.common.utils.uuid.IdUtils;
import com.fivetech.common.utils.uuid.Seq;
...
public class FileUploadUtils
{
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = FiveTechConfig.getProfile();
    ...
    {
        int dirLastIndex = FiveTechConfig.getProfile().length() + 1;
