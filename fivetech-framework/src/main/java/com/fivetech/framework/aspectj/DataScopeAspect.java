...
import com.fivetech.framework.security.context.PermissionContextHolder;
...
public class DataScopeAspect
{
    ...
    public static void dataScopeFilter(JoinPoint joinPoint, SysUser user, String userAlias, String deptAlias, String userField, String deptField, String permission)
    {
        ...
        for (SysRole role : user.getRoles())
        {
            ...
            {
                sqlString.append(StringUtils.format(" OR {}.{} IN ( SELECT dept_id FROM sys_dept WHERE dept_id = {} OR position(',' || {} || ',' IN ',' || ancestors || ',') > 0 )", deptAlias, deptField, user.getDeptId(), user.getDeptId()));
            }
